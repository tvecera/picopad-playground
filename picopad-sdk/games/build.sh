...
for dir in */ ; do
    ...
    -G Ninja \
    -S /Users/ranajkus/devel/pico/picopad-playground/picopad-sdk/games/"${dir}" \
    -B /Users/ranajkus/devel/pico/picopad-playground/picopad-sdk/games/"${dir}"/cmake-build-release || exit 1
