...
if (NOT PICOPAD_BASE_PATH)
    if (PICOPAD_BASE_FETCH_FROM_GIT)
        ...
        if (PICO_SDK_PATH AND EXISTS "${PICO_SDK_PATH}/../picopad_base")
            ...
            message(FATAL_ERROR
                    "PICO LIBS location was not specified. Please set PICOPAD_BASE_PATH or set PICOPAD_BASE_FETCH_FROM_GIT to on to fetch from git."
                    )
        endif()
    endif ()
endif ()

set(PICOPAD_BASE_PATH "${PICOPAD_BASE_PATH}" CACHE PATH "Path to the PICO LIBS")
set(PICOPAD_BASE_FETCH_FROM_GIT "${PICOPAD_BASE_FETCH_FROM_GIT}" CACHE BOOL "Set to ON to fetch copy of PICO LIBS from git if not otherwise locatable")
set(PICOPAD_BASE_FETCH_FROM_GIT_PATH "${PICOPAD_BASE_FETCH_FROM_GIT_PATH}" CACHE FILEPATH "location to download LIBS")
...
set(PICOPAD_BASE_PATH ${PICOPAD_BASE_PATH} CACHE PATH "Path to the PICO LIBS" FORCE)
